...
sudo ./install.sh --uninstall  # remove, put this host on bbr + fq, remove the
                               #   packages the install added (keeps /etc/skyline-speeder)
sudo ./install.sh --uninstall --restore-pre-install   # ... but put back the
